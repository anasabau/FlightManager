...
insert into company (id, name, country, headquarters, is_active) values (3, 'Jaxspan', 'Yemen', 'Aş Şalw', 1);
insert into company (id, name, country, headquarters, is_active) values (4, 'Edgeify', 'Bangladesh', 'Tāngāil', 1);
...
insert into company (id, name, country, headquarters, is_active) values (12, 'Livetube', 'Brazil', 'Canindé', 1);
insert into company (id, name, country, headquarters, is_active) values (13, 'Yamia', 'Argentina', 'Santo Tomé', 1);
